package com.example.dealingapp.mvc.inner.table.table3;
...
import com.example.dealingapp.mvc.plugin.table.GTableFixColumnManager;
...
import com.example.dealingapp.mvc.plugin.table.cell.editor.DefaultJTextFieldEditor;
...
import com.example.dealingapp.mvc.plugin.table.cell.render.DefaultJTextFieldRender;
...
public class Table3 extends AbstractInnerFrame {
	...
	protected void initGUI(FormBuilder builder) {
		...
		GTableColumn col1 = new GTableColumn("New GroupA", "col1", "num", "setRowNum", "getRowNum", Integer.class, 40,
				true, MyRow.class);
		GTableColumn col2 = new GTableColumn("New GroupA_1", "col2", "money", "setMoney", "getMoney", BigDecimal.class,
				120, false, MyRow.class);
		GTableColumn col3 = new GTableColumn("New GroupA_1", "col3", "mark", "setjComboBox", "getjComboBox",
				String.class, 120, false, MyRow.class);
		GTableColumn col4 = new GTableColumn("New GroupA_2", "col4", "mark-2", "setCheckBox", "getCheckBox",
				Boolean.class, 40, false, MyRow.class);
		GTableColumn col5 = new GTableColumn("New GroupA_2", "col5", "mark-3", "setjButton", "getjButton", String.class,
				80, false, MyRow.class);
		GTableColumn col6 = new GTableColumn("New GroupA_2", "col6", "mark-4", "setSpinner", "getSpinner",
				Integer.class, 60, false, MyRow.class);
		GTableColumn col7 = new GTableColumn("New GroupA_2", "col7", "updatetime", "setUpdateTime", "getUpdateTime",
				Date.class, 120, false, MyRow.class);
		GTableColumn col8 = new GTableColumn("New GroupA_2", "col7", "status", "setImage", "getImage", Integer.class,
				60, false, MyRow.class);
		GTableColumn col9 = new GTableColumn("New GroupA_2", "col7", "progress", "setProgress", "getProgress",
...
//		col4.setCellEditor(new DefaultJCheckBoxEditor(new JCheckBox()));
		//
		col4.setCellRenderer(new DefaultJTextFieldRender(SwingConstants.CENTER));
		col4.setCellEditor(new DefaultJTextFieldEditor(new JTextField()));
		// button col
...
//		}));
		...
		builder.add(fixTable).xy(1, 1).add(btnPanel).xy(2, 1, "fill,top").build();
	}
